...
`b01bc0de00a5a5a5a5ffff100300000008dd225500ff0000ffff`

其中时域设置为`08dd2255`，周期8秒，底部占周期比13/15，顶部占底部比2/15，上升沿占上升下降之和比例为5/15，即呼气是吸气的两倍时间。

上面的例子是最低亮度为0的，也可以试一下最低亮度不为0的。

`b01bc0de00a5a5a5a5ffff100300000008dd225500ff2200ffff`
